    ...
    <div id="content">
    	<div class="page-header">
    		<div class="container-fluid">
				<h1>@Lang('admin::admin.heading.edit')</h1>
				<ul class="breadcrumb">
					...
					<li><a href="{{ route('admin.admin.edit',['id'=>$admin->id]) }}">@Lang('admin::admin.heading.edit')</a></li>
				</ul>
		...
		<div class="container-fluid">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="fa fa-pencil"></i> @Lang('admin::admin.heading.edit')</h3>
				</div>
						...
						<div class="tab-content">
				            <div class="tab-pane active" id="tab-general">
				            	<div class="form-group required">
									<label class="col-sm-2 control-label">@Lang('admin::admin.form.email')</label>
									<div class="col-sm-10">
								...
								<div class="form-group required">
									...
									<div class="col-sm-10">
										<input name="name" value="{{ old('name')?old('name'):$admin->name }}" placeholder="@Lang('admin::admin.form.name')" id="input-name" class="form-control" type="text">
									</div>
								</div>
								<div class="form-group required">
